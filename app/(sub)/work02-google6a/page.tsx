      ...
      <div className={styles.description}>
        ...
        <dl>
          ...
          <dd>
            ...
            audience. Our second challenge of ensuring efficient use of dollars to avoid spillage
            was addressed by identifying the high density Mandarin speaking geo location leveraging
            FSA as well as the Meta digital data. The data points enabled us to strategically buy
            Transit Shelters, Store Posters and Horizontal banners within communities with the
            maximum Mandarin footfall across the Greater Toronto and Greater Vancouver Areas. The
            creative leveraged was simple yet engaging with the same message in Mandarin that
